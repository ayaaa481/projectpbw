...
if(isset($_POST['add_to_cart'])){
   ...
   if(mysqli_num_rows($check_cart_numbers) > 0){
      $message[] = 'Produk sudah ditambkan ke keranjang!';
   }else{
...
<section class="home">
   <div class="content">
      <h3>Dunia dalam Genggaman Anda </h3>
      <p>Belanja Buku dengan Mudah di Toko Buku Online Kami</p>
      <a href="about.php" class="white-btn">Lebih Lanjut</a>
   </div>
</section>
...
<section class="home-contact">
   <div class="content">
      ...
      <p>Jika Anda memiliki pertanyaan, jangan ragu untuk menghubungi kami di bawah ini. Kami siap membantu Anda dengan informasi yang Anda butuhkan.</p>
